...
library ImpermanentLibrary {
    ...
    function getUpdatedPriceAverage(
        ...
        require(_currentTimestamp >= _priceAverageLastTimestamp, "ImpermanentLibrary: INVALID_TIMESTAMP");
    ...
    {
        require(_param.amount != 0, "ImpermanentLibrary: INSUFFICIENT_INPUT_AMOUNT");
        require(
            _param.reserveIn != 0 && _param.reserveOut != 0 && _param.fictiveReserveIn != 0
                && _param.fictiveReserveOut != 0,
            "ImpermanentLibrary: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 _firstAmountIn = computeFirstTradeQtyIn(
            ImpermanentLibrary.GetAmountParameters({
    ...
    {
        require(_param.amount != 0, "ImpermanentLibrary: INSUFFICIENT_OUTPUT_AMOUNT");
        require(
